function Locs_Extraction_Module_LAMTOR_batch()
...
figure();
set(gcf,'name','Localization Extraction LAMTOR Batch Module','NumberTitle','off','color','k','units','normalized','position',[0.25 0.2 0.5 0.6],'menubar','none','toolbar','figure');
