function loc_list_montage_singlecolor(data,scatter_num)

global Int

answer = inputdlg({'Scatter 1st channel: ','Color 1: '},'Input',[1 50],{'10','c'});
scatter_size(1) = str2double(answer{1});
Color1 = answer{2};
...
if length(data)>6
    ...
    for i = 1:length(data)        
        ...
        scatter(data_down_sampled{i}.x_data,data_down_sampled{i}.y_data,scatter_size,Color1,'filled');
