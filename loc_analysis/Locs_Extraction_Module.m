...
data_colocalization = [];
    ...
    function colocalization_callback(~,~,~)
        ...
        if isempty(input_values)
            ...
            if Stats == 1
                [file,path] = uiputfile('NewLysoMaskExtraction.xlsx','Please specify a name to save the statistics as'); % Extract the name of the file given.
